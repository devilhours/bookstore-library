      ...
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <Link to="/" className="flex items-center gap-2 text-white">
              <div className="bg-emerald-500/20 p-2 rounded-full">
                <FaBookAtlas className="h-6 w-6 text-emerald-400" />
              </div>
          ...
          <div className="hidden md:flex md:items-center md:space-x-8">
            <NavLink to="/" className={navLinkStyle}>All Books</NavLink>
            {authUser && (
              <>
                <NavLink to="/addproduct" className={navLinkStyle}>Add Book</NavLink>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-gray-800 pb-4">
            <div className="flex flex-col space-y-4 px-2 pt-2 pb-3">
              <NavLink to="/" className={navLinkStyle} onClick={() => setIsMobileMenuOpen(false)}>All Books</NavLink>
              {authUser ? (
                <>
                  <NavLink to="/addproduct" className={navLinkStyle} onClick={() => setIsMobileMenuOpen(false)}>Add Book</NavLink>
